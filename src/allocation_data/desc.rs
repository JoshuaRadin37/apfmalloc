...
impl Descriptor {
    pub fn new(next_free: Atomic<DescriptorNode>, next_partial: Atomic<DescriptorNode>, anchor: Anchor, super_block: *mut u8, proc_heap: *mut ProcHeap, block_size: u32, max_count: u32) -> Self {
    ...
    pub fn retire(&'static mut self) {
        ...
        loop {
            ...
            new_head.set(self, old_head.get_counter().expect("Counter Should exist") + 1);
